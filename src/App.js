...
const providerOptions = {
  ...
  walletconnect: {
    ...
    options: {
      infuraId: "780add2ef5524aea83c15bc6671827c1"
    }
  },
  walletlink: {
    package: WalletLink,
    options: {
      appName: "NFT DAO Minter",
      infuraId: "780add2ef5524aea83c15bc6671827c1",
      rpc: "",
      chainId: 4,
      appLogoUrl: null,
          ...
          <div className='col'>
            <body className='nftstaker border-0'>
              <form style={{ fontFamily: "SF Pro Display" }} >
                <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>NFT DAO Staking Vault </h2>
                ...
                <div className="row px-3">
                  ...
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", fontFamily: "SF Pro Display" }}>
                      ...
                      <Button onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned NFTD Rewards</Button>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    <div style={{ fontSize: '25px', borderRadius: '14px', color: "#ffffff", fontWeight: "300" }}>NFT DAO Staking Pool Active Rewards</div>
                    ...
                    <div class="header">
                      <div style={{ fontSize: '25px', borderRadius: '14px', fontWeight: '300' }}>NFTD Token Stake Farms</div>
